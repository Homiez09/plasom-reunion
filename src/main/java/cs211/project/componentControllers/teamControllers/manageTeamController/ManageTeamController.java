...
public class ManageTeamController {
    ...
    private void loadManageTeamComponent(User user, int col, int row) {
        FXMLLoader manageTeamLoader = new FXMLLoader(getClass().getResource("cs211/project/views/components/team/manage-team/manage-team.fxml"));
        ...
        if (user != null) {
            try {
                ...
                // Label bookmarkLabel = (Label) manageTeamComponent.getChildren().get(3);
                ...
                statusImageView.setImage(new Image(getClass().getResourceAsStream("/images/icons/team-box/active_icon.png")));
            } catch (IOException e) {
